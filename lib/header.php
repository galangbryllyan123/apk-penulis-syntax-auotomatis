				...
				<div class="container-fluid">
					<div class="logo">
						<a href="<?php echo $config['web']['base_url'] ?>" class="logo">
							...
							<span class="logo-large"><i class="fa fa-globe"></i> <?php echo $config['web']['title'] ?></span>
						</a>
					</div>
...
?>
								<li>
									<a href="<?php echo $config['web']['base_url'] ?>admin"> <i class="fa fa-gears"></i> Admin</a>
								</li>
<?php
}
?> 
							    ...
							    <li>
									<a href="<?php echo $config['web']['base_url'] ?>page/hof.php"> <i class="fa fa-trophy"></i> Top 5</a>
								</li>
								...
								<li class="has-submenu">
									<a href="#"><i class="fa fa-envelope"></i> Tiket</a>
									<ul class="submenu">
										<li><a href="<?php echo $config['web']['base_url'] ?>ticket/submit.php">Submit</a></li>
										<li><a href="<?php echo $config['web']['base_url'] ?>ticket">Daftar</a></li>
									</ul>
								</li>
								<li>
...
?>
								...
								<li>
									<a href="<?php echo $config['web']['base_url'] ?>price_list/index.php"> <i class="fa fa-list"></i> Daftar Layanan</a>
								</li>
								<li class="has-submenu">
