					...
					<div id="navigation">
						...
						<li class="has-submenu">
							...
							<ul class="submenu">
								...
								<li><a href="<?php echo $config['web']['base_url'] ?>admin/deposit/report.php">Laporan</a></li>
							</ul>
						</li>
						<li class="has-submenu">
							...
							<ul class="submenu">
								...
								<li><a href="<?php echo $config['web']['base_url'] ?>admin/order/report.php">Laporan</a></li>
							</ul>
						</li>
						<li class="has-submenu">
							<a href="#"><i class="fa fa-file"></i> Log</a>
							<ul class="submenu">
								<li><a href="<?php echo $config['web']['base_url'] ?>admin/log/login.php">Masuk</a></li>
								<li><a href="<?php echo $config['web']['base_url'] ?>admin/log/balance-usage.php">Penggunaan Saldo</a></li>
							</ul>
						</li>
						<li class="has-submenu">
