...
?>
				<div class="row">
					<div class="col-lg-12">
		                <div class="card-box">
                                <center>
                                    <i class="fa fa-question text-green" style="font-size: 40px;"></i>
            	                    <h4 class="text-uppercase">Tentang Kami?</h4>
            					    <p><?php echo $config['web']['meta']['description'] ?> </p>
            						<a href="<?php echo $config['web']['base_url'] ?>auth/login" class="btn btn-success"><i class="fa fa-sign-in fa-fw"></i> Masuk</a> 
					...
					<div class="col-lg-4">
                        <div class="card-box">
                        	...
                        	<small>Kami menyediakan berbagai layanan terbaik untuk kebutuhan sosial media & pulsa Anda.</small>
                        	</center>
                        </div>
                    </div>
